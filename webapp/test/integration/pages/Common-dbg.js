sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			...
			if (sHash) {
				sHash = "#AppraisalForms-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#AppraisalForms-display";
			}
		...
		return Opa5.extend("hcm.ux.hapv3.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["hcm/ux/hapv3/localService/mockserver"], function (mockserver) {
